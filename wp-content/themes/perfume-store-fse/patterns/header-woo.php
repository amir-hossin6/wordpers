...
<div class="wp-block-group alignfull is-style-default" style="border-bottom-color:var(--wp--preset--color--secondary-100);border-bottom-width:1px"><!-- wp:group {"className":"is-style-section-6 is-style-section-4","style":{"spacing":{"padding":{"top":"var:preset|spacing|8","bottom":"var:preset|spacing|8"}}},"layout":{"type":"constrained"}} -->
  <div class="wp-block-group is-style-section-6 is-style-section-4" style="padding-top:var(--wp--preset--spacing--8);padding-bottom:var(--wp--preset--spacing--8)"><!-- wp:group {"align":"wide","style":{"spacing":{"blockGap":"var:preset|spacing|8"}},"layout":{"type":"flex","justifyContent":"space-between","flexWrap":"wrap"},"rowXSWrap":"wrap"} -->
    <div class="wp-block-group alignwide"><!-- wp:group {"align":"wide","style":{"spacing":{"blockGap":"var:preset|spacing|8"}},"layout":{"type":"flex","flexWrap":"nowrap"},"rowXSJustification":"center","rowSMJustification":"flex-start","rowXSFlexBasis":"100%"} -->
      <div class="wp-block-group alignwide"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|8"},"typography":{"lineHeight":"1"}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
        <div class="wp-block-group" style="line-height:1"><!-- wp:image {"width":"18px","sizeSlug":"full","linkDestination":"none","className":"is-style-icon-aware-1"} -->
          <figure class="wp-block-image size-full is-resized is-style-icon-aware-1"><img src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/assets/icons/plane-departure-light.webp" alt="" class="" style="width:18px" /></figure>
          <!-- /wp:image -->
          ...
          <p class="is-style-text-aware-1 is-style-text-note has-base-color has-text-color has-link-color"><?php esc_html_e('Free global shipping on $50+ orders', 'perfume-store-fse'); ?></p>
          <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
      </div>
      ...
      <div class="wp-block-group alignwide"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|8"},"typography":{"lineHeight":"1"}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
        <div class="wp-block-group" style="line-height:1"><!-- wp:image {"width":"18px","sizeSlug":"full","linkDestination":"none","className":"is-style-icon-aware-1"} -->
          <figure class="wp-block-image size-full is-resized is-style-icon-aware-1"><img src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/assets/icons/phone-light.webp" alt="" class="" style="width:18px" /></figure>
          <!-- /wp:image -->
        ...
        <!-- wp:paragraph {"className":"is-style-text-aware-1 is-style-text-note-2","style":{"elements":{"link":{"color":{"text":"var:preset|color|secondary-800"}}}},"textColor":"secondary-800"} -->
        <p class="is-style-text-aware-1 is-style-text-note-2 has-secondary-800-color has-text-color has-link-color"><?php esc_html_e('|', 'perfume-store-fse'); ?></p>
        <!-- /wp:paragraph -->

        <!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|8"},"typography":{"lineHeight":"1"}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
        <div class="wp-block-group" style="line-height:1"><!-- wp:image {"width":"18px","sizeSlug":"full","linkDestination":"none","className":"is-style-icon-aware-1"} -->
          <figure class="wp-block-image size-full is-resized is-style-icon-aware-1"><img src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/assets/icons/envelope-light.webp" alt="" class="" style="width:18px" /></figure>
          <!-- /wp:image -->

          <!-- wp:paragraph {"className":"is-style-text-aware-1 is-style-text-note","style":{"elements":{"link":{"color":{"text":"var:preset|color|base"}}}},"textColor":"base"} -->
          <p class="is-style-text-aware-1 is-style-text-note has-base-color has-text-color has-link-color"><?php esc_html_e('info@domain.com', 'perfume-store-fse'); ?></p>
          <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
      </div>
