  ...
  <div id="welcome-panel" class="welcome-panel">
    <div class="welcome-panel-content">
      <div class="welcome-panel-header">
        ...
        <h2><?php esc_html_e('Perfume Store FSE', 'perfume-store-fse'); ?></h2>
        <p>
          <a href="https://designorbital.com/wordpress-theme/free-fragrance-shop-wordpress-theme-perfume-store-fse/" class="button button-primary" target="_blank" rel="noopener noreferrer nofollow">
      ...
      <div class="welcome-panel-column-container">
        <div class="welcome-panel-column">
          ...
          <div class="welcome-panel-column-content">
            <h3><?php esc_html_e('Discount Code: WPCOMMUNITY30', 'perfume-store-fse'); ?></h3>
            <p><?php esc_html_e('Upgrade this theme or buy any theme/bundle with discount code. Thank you for your support.', 'perfume-store-fse'); ?></p>
          </div>
        </div>
        <div class="welcome-panel-column">
          <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
          ...
          <div class="welcome-panel-column-content">
            <h3><?php esc_html_e('Premium Features', 'perfume-store-fse'); ?></h3>
            <p><?php esc_html_e('Pro gives you exclusive blocks and patterns to elevate your site with a sleek, professional style.', 'perfume-store-fse'); ?></p>
          </div>
        </div>
        <div class="welcome-panel-column">
          <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
          ...
          <div class="welcome-panel-column-content">
            <h3><?php esc_html_e('All Access Pass', 'perfume-store-fse'); ?></h3>
            <p><?php esc_html_e('Unlock all current and future WordPress themes with the All Access Pass — one pass, one low price.', 'perfume-store-fse'); ?></p>
          </div>
        </div>
      </div>
    </div>
