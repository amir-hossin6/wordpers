  ...
  <div id="welcome-panel" class="welcome-panel">
    <div class="welcome-panel-content">
      <div class="welcome-panel-header">
        ...
        <h2><?php esc_html_e('Fresh Blog Lite', 'fresh-blog-lite'); ?></h2>
        <p>
          <a href="https://designorbital.com/wordpress-theme/free-personal-blog-wordpress-theme-fresh-blog/" class="button button-primary" target="_blank" rel="noopener noreferrer nofollow">
      ...
      <div class="welcome-panel-column-container">
        <div class="welcome-panel-column">
          ...
          <div class="welcome-panel-column-content">
            <h3><?php esc_html_e('Discount Code: WPCOMMUNITY30', 'fresh-blog-lite'); ?></h3>
